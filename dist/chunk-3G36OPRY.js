  ...
  return /* @__PURE__ */ jsxs("div", { class: "bases-list-wrapper", children: [
    ...
    /* @__PURE__ */ jsx("div", { class: "bases-list-group", children: /* @__PURE__ */ jsx("div", { class: "bases-list-group-list", children: entries.map((entry) => {
      ...
      for (const column of secondaryColumns) {
        ...
        secondaryItems.push(
          /* @__PURE__ */ jsx("span", { class: "bases-list-property", children: /* @__PURE__ */ jsx("span", { class: "bases-rendered-value", children: renderCellValue(value, ctx) }) })
        );
      }
      return /* @__PURE__ */ jsx("div", { class: "bases-list-item", children: /* @__PURE__ */ jsxs("div", { class: "bases-list-item-properties", children: [
        /* @__PURE__ */ jsxs("span", { class: "bases-list-property", children: [
          /* @__PURE__ */ jsx("span", { class: "list-bullet", children: "-" }),
          /* @__PURE__ */ jsx("span", { class: "bases-rendered-value", children: primaryValue })
        ] }),
        secondaryItems.map((item) => /* @__PURE__ */ jsxs(Fragment, { children: [
          /* @__PURE__ */ jsx("span", { class: "bases-list-separator", children: ", " }),
          item
        ] }))
      ] }) });
    }) }) })
    ...
    /* @__PURE__ */ jsxs("table", { class: "bases-table", "data-view-type": "table", children: [
      ...
      /* @__PURE__ */ jsx("tbody", { children: groups ? Array.from(groups.entries()).map(([label, groupEntries2]) => /* @__PURE__ */ jsxs(Fragment, { children: [
        /* @__PURE__ */ jsx("tr", { class: "bases-table-group-header", children: /* @__PURE__ */ jsxs("td", { colSpan: columns.length, children: [
          groupPropertyLabel && /* @__PURE__ */ jsxs("span", { class: "bases-table-group-property", children: [
            groupPropertyLabel,
            " "
          ] }),
